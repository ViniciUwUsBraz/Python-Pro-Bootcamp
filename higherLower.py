...
while(run):
    ...
    while(option!='A' and option!='B'):
        option=input("Invalid option, type again: ").upper()

    if(option=='A' and data[first]['follower_count']>data[second]['follower_count']):
        os.system("clear")
        score+=1
        print(f"You're right, Current score: {score}")
    elif(option=='B' and data[second]['follower_count']>data[first]['follower_count']):
        os.system("clear")
        score+=1
        print(f"You're right, Current score: {score}")
    else:
